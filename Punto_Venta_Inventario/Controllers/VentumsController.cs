...
namespace Punto_Venta_Inventario.Controllers
{
    public class VentumsController : Controller
    {
        ...
        public VentumsController(PuntoVentaInventarioContext context)
        {
            _context = context;
        }
        ...
        {
            var puntoVentaInventarioContext = _context.Venta.Include(v => v.IdClienteNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdVenta,IdCliente,FechaVenta,Total,UsuarioCrea,FechaCreacion,UsuarioActualiza,FechaActualizacion,Estado")] Ventum ventum)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdVenta,IdCliente,FechaVenta,Total,UsuarioCrea,FechaCreacion,UsuarioActualiza,FechaActualizacion,Estado")] Ventum ventum)
        {
