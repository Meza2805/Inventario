...
namespace Punto_Venta_Inventario.Controllers
{
    public class CategoriumsController : Controller
    {
        ...
        public CategoriumsController(PuntoVentaInventarioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> VistaCategoria()
        {
            return View(await _context.Categoria.ToListAsync());
        ...
        public async Task<IActionResult> Create([Bind("IdCategoria,Nombre,Descripcion,UsuarioCrea,FechaCreacion,UsuarioActualiza,FechaActualizacion,Estado")] Categorium categorium)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCategoria,Nombre,Descripcion,UsuarioCrea,FechaCreacion,UsuarioActualiza,FechaActualizacion,Estado")] Categorium categorium)
        {
